...
build:
	@echo
	@echo "### Building release/vela-executor binary"
	GOOS=linux CGO_ENABLED=0 \
		go build -a \
		-o release/vela-executor \
...
build-static:
	@echo
	@echo "### Building static release/vela-executor binary"
	GOOS=linux CGO_ENABLED=0 \
		go build -a \
...
execute:
	@echo
	@echo "### Executing release/vela-executor binary"
